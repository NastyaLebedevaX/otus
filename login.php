                        ...
                        <div class="bg-white p-4 p-md-5 rounded shadow-sm">
                            ...
                            <form action="login.php" method="post">
                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button name="login" class="btn btn-lg btn-primary" type="submit">Вход</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                        <a href="registration.php" class="link-secondary text-decoration-none">Зарегистрироваться</a>
                                    </div>
                                </div>
                            </div>
                        </div>
